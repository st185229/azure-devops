...
@click.option("--name", prompt="I need your name", help="Need name" ,default="Suresh")
@click.option("--color", prompt="I need your color", help="This is your color", default = "Blue")
